    ...
    <header className="bg-white/60 backdrop-blur supports-[backdrop-filter]:backdrop-blur-lg border-b sticky top-0 z-50" role="banner">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between max-w-6xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-black">
              <Link href="/" className="focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-md" aria-label="Sure.Financial Home">Sure.Financial</Link>
            </h2>
        ...
        <nav className="hidden md:flex gap-6 items-center" aria-label="Main Navigation">
          ...
          <a 
            href="#upload-section" 
            className="ml-2 px-4 py-2 bg-amber-700 text-white rounded-md hover:shadow-md transition-all font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-600"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t py-4 px-4 shadow-lg" id="mobile-menu">
          <nav className="flex flex-col space-y-4" aria-label="Mobile Navigation">
            ...
            <a 
              href="#upload-section" 
              className="px-4 py-2 bg-amber-700 text-white rounded-md hover:shadow-md transition-all font-medium text-center mt-2 focus:outline-none focus:ring-2 focus:ring-amber-600"
              onClick={() => setMobileMenuOpen(false)}
              aria-label="Get started with statement parsing"
            >
              Get Started
